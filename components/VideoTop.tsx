...
export default function VideoTop({ videoUrl }: { videoUrl: any }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl">
      ...
      <video
        poster={videoUrl}
        className="lg:hidden border-4 rounded-2xl shadow-2xl shadow-white lg:max-h-[550px] w-full object-cover"
        src={videoUrl}
      ...
      <video
        ...
        loop
        playsInline
        className="hidden lg:block border-4 rounded-2xl shadow-2xl shadow-white lg:max-h-[550px] w-full object-cover"
        src={videoUrl}
        onClick={(e) => handlePlayPause(e.currentTarget)}
      ></video>
